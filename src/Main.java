...
public class Main {
    ...
    public static int[] heroesHealth = {400, 280, 270, 250,};
    public static int[] heroesDamage = {0, 10, 15, 20,};
        ...
        ; if (heroesHealth[3] > 0) {
            for (int i = 0; i < heroesHealth.length; i++) {
                ...
                if (heroesHealth[i] > 0 && heroesHealth[i] <100) {
                    heroesHealth[i] += medic; System.out.println("Medic healed " + heroesAttackType[i]);
                    break;
                }
            }
        }
